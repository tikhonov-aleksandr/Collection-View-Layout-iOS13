...
extension App {
    static func testData() -> [App] {
        ...
        let app3 = App(title: "telegram", subtitle: "Inside the Am2901", imageName: "telegram-app")
        ...
        return [app1, app2, app3, app5, app6, app7, app8, app9, app10, app11, app12, app13, app14, app4]
    }
}
